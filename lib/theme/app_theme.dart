...
class AppTheme {
  ...
  // Agricultural Earth Palette - Natural, high-contrast colors optimized for outdoor mobile viewing
  ...
  static const Color accentLight = Color(0xFFFF8F00); // Alert orange
  ...
  // Shadow colors - Subtle elevation using 2dp and 4dp Material Design shadows
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Headline styles - Inter for mobile screens with Hindi/Devanagari support
      ...
      // Body styles - Inter for consistent reading experience
      ...
      // Label styles - Inter for captions and small data labels
